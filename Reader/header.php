...
<head>
    ...
    <link rel="icon" href="/Authentication/image/logo.png">
...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <!-- No function on search -->
            <!-- <li class="search-container"><img class="search-image" src="image/search.png" alt=""> 
            ...
            <li id="com"><a href="comments.php">Comments</a></li>
            <li id="prof_hide"><a href="profile.php">Profile</a></li>
